...
This document provides guidelines for contributing to BORG's codebase and documentation.
These guidelines are meant to help, not restrict. If in doubt, use your best judgment and feel free to propose improvements through an issue or pull request.
...
BORG uses **testthat** for testing.
...
- Which BORG function was called and with what arguments
