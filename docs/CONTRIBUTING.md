...
This document provides guidelines for contributing to BORG’s codebase
and documentation. These guidelines are meant to help, not restrict. If
in doubt, use your best judgment and feel free to propose improvements
...
[README](https://gillescolling.com/BORG/README.md).

### Obtaining the source

Clone the BORG repository:

``` bash
git clone https://github.com/gcol33/BORG.git
cd BORG
```
...
BORG uses **testthat** for testing. All tests are located in
`tests/testthat/`.
...
testthat::test_file("tests/testthat/test-borg_inspect.R")
```
...
vs. actual results - Which BORG function was called and with what
arguments - R and operating system version

------------------------------------------------------------------------

By contributing to BORG, you agree that your code is released under the
