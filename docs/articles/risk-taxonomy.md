...
**Detection**: Compare preprocessing parameters to train-only
statistics.
...
**What**: Target encoding, embeddings, or derived features computed on
full data.
...
**What**: Temporal purge/embargo period shorter than autocorrelation
decay.
...
**What**: “External” dataset shares time/geography/institution with
training.
