...
## What is BORG?
BORG (Bounded Outcome Risk Guard) automatically detects when model evaluation
is compromised by information leakage between training and test data. It
identifies violations that inflate performance estimates and provides
...
Use `borg_guard()` to create a protected evaluation context:
