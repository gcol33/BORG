...
parameters. If they differ, preprocessing used test data.
...
**Detection**: Compute correlation of each numeric feature with target column
on training data.
...
**Detection**: Check if any fold's training indices intersect with held-out
test set.
...
These bias results but model ranking may be preserved. BORG warns but continues.
...
**Detection**: Compute convex hull of training points, count how many test
points fall inside.
